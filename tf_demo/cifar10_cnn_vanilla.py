...
for step in range(max_steps):
    ...
    _, loss_value = sess.run([train_op,loss], feed_dict={image_batch:image_batch,label_holder:label_batch})
...
num_examples = 10000
import math
num_tier = int(math.ceil(num_examples / batch_size))
true_count = 0
total_samples_count = num_tier * batch_size
step = 0
while step < num_tier:
